// galleryOverlay.ts — Flux2 Klein 이미지 갤러리 오버레이. Krea2/Z-Image와 동일 패턴.
...
export function createGalleryOverlay(state: { saveSubfolder: string }, onReuse: (meta: any) => void, onSendTo: (mode: string, field: string, extra: string | undefined, filename: string) => void) {
  ...
  topRow.appendChild(el("div", { text: "🖼 Gallery — Flux2 Klein", style: { color: "#fff", fontSize: "14px", fontWeight: "700", flex: "1" } }));
